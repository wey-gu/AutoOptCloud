'''
referring to https://wiki.python.org/moin/PythonDecoratorLibrary#Retry
'''
import time
import math
from cloud_pipeline.utils.logger import Logger
...
def retry(tries, delay=3, backoff=2):
    ...
    greater than 1, or else it isn't really a backoff. tries must be at
    least 0, and delay greater than 0.
    '''
